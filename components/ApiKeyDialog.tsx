  ...
  return (
    <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
      <div className="bg-gray-800 border border-gray-700 rounded-2xl shadow-xl max-w-lg w-full p-8 text-center flex flex-col items-center">
        ...
        <h2 className="text-3xl font-bold text-white mb-4">API Key Required for Product Video Pro</h2>
        <p className="text-gray-300 mb-6">
          This tool uses Veo, a paid-only video generation model, to create high-quality product videos. To proceed, please select an API key associated with a Google Cloud project that has billing enabled.
        </p>
